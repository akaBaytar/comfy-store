  ...
  return (
    <section className='grid lg:grid-cols-2 items-center gap-y-20'>
      <div className='text-center lg:text-start'>
        ...
        <p className='mt-8 max-w-2xl text-lg sm:text-xl leading-8'>
      ...
      <div className='h-[30rem] mx-auto lg:mx-0 max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-96 p-4 bg-neutral rounded-box lg:justify-self-end'>
        <Carousel />
      </div>
    </section>
  );
