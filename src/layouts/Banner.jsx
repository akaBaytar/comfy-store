  ...
  return (
    <section className='pt-20'>
      <div className='banners grid gap-4 sm:grid-cols-2'>
        ...
        <article className='rounded-2xl h-60 pl-4 pt-4 text-base-300 sm:row-start-1'>
        ...
        <article className='rounded-2xl h-60 pl-4 pt-4 text-base-300 sm:row-start-2'>
        ...
        <article className='rounded-2xl h-64 text-center sm:text-start sm:flex sm:items-center sm:gap-8 sm:pl-8 text-base-300 sm:col-span-2 sm:row-span-1 sm:h-40'>
